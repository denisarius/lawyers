...
// col_width    - размер колонок в таблице для типа 'tb' (формат: <width>|<width>|...|<width>)
...
// can_have_same_name - возможность заводить объекты с одинаковыми именами в одном разделе
// admin_sort - сортировка объектов в админке. При наличии этого параметра отключается возможность сортировать объекты вручную

$_o['cms_objects_types']=$_cms_objects_types=array(
	array(
		'id'=>'1', 'name'=>'Услуги юриста', 'menu_item_id'=>'17',
		'no_object_image'=>true,
		'details'=>array(
			array('id'=>'section', 'name'=>'Раздел', 'type'=>'menu'),
			array('id'=>'prices', 'name'=>'Цены', 'type'=>'tb', 'columns'=>'Услуга|Описание|Цена', 'width'=>1000, 'col_width'=>'250|550|80'),
		)),

	array(
		'id'=>'2', 'name'=>'Услуги бухгалтера', 'menu_item_id'=>'29',
		'no_object_image'=>true,
		'details'=>array(
			array('id'=>'section', 'name'=>'Раздел', 'type'=>'menu'),
			array('id'=>'prices', 'name'=>'Цены', 'type'=>'tb', 'columns'=>'Услуга|Описание|Цена', 'width'=>800, 'col_width'=>'250|550|80'),
		)),
