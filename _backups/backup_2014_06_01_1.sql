...
insert into objects (`id`, `menu_item`, `type`, `name`, `note`, `image`, `gallery`, `sort`, `date`, `visible`) values ('1', '17', '1', 'услуги юриста для ИП', '<p>\n	<strong>Услуги юриста для ИП</strong></p>\n<ol>\n	<li>\n		Оформление отчетности</li>\n	<li>\n		Оформление платежных документов</li>\n</ol>\n', '', '0', '0', '2014-06-01', '1');
...
insert into objects_details (`id`, `node`, `typeId`, `type`, `value`) values ('2', '1', 'section', 'menu', '19'),('3', '1', 'prices', 'tb', '[оформление отчетности][подготовка документов, предоставление в налоговую инспекцию][1000]'),('4', '1', 'prices', 'tb', '[оформление платежных документов][подготовка платежных поручений по налогам и отчислениям в фонды][500]');
