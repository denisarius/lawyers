<?php
	...
	// language		- ID языка комментария
	// date			- дата добавления
	// content		- текст комментария
	// author		- автор комментария (подпись)
	// ip			- IP-адрес автора комментария
	// status		- статус комментария (0-не просмотрен модератором, 1-отклонен, 2-одобрен)
	if (isset($_cms_comments_table) && $_cms_comments_table!='')
		array_push($_admin_db_structure,
			array('name'=>$_cms_comments_table,
				'fields'=>array(
					array('name'=>'id', 		'type'=>'int(11)',		'primary'=>true),
					array('name'=>'language',	'type'=>'varchar(5)',	'primary'=>false, 'null'=>true),
					array('name'=>'date',  		'type'=>'date',			'primary'=>false, 'null'=>true),
					array('name'=>'content',  	'type'=>'text',			'primary'=>false, 'null'=>true),
					array('name'=>'author',		'type'=>'varchar(250)',	'primary'=>false, 'null'=>true),
					array('name'=>'ip',	 		'type'=>'varchar(30)',	'primary'=>false, 'null'=>true),
					array('name'=>'status',	 	'type'=>'int(11)', 		'primary'=>false, 'default'=>'0'),
				),
				'indexes'=>array(
				)
