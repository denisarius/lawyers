...
if (isset($_cms_users_addresses_table) && $_cms_users_addresses_table != '')
	array_push(
		$_admin_db_structure,
		array(
			'name' => $_cms_users_addresses_table,
			'fields' => array(
				array('name' => 'id', 'type' => 'int(11)', 'primary' => true),
