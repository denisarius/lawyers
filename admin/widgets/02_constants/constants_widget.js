...
function constants_constant_add_save() {
    ...
    if (name == '')
        ...
        save = false;
        if (val == '')
            confirm_box("Добавление константы", "Записать константу c <u>пустым значением</u>?", function () {
                save = true;
            });
        else
            save = true;
...
function constants_constant_edit_save() {
    ...
    if (name == '') {
        ...
        save = false;
        if (val == '')
            confirm_box("Изменение константы", "Записать константу c <u>пустым значением</u>?", function () {
                save = true;
            });
        else
            save = true;
