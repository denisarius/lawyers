...
if (isset($_SESSION['pmf_allowed_extension']) &&
	$_SESSION['pmf_allowed_extension'] != ''
) $pmf_allowed_extension = $_SESSION['pmf_allowed_extension'];

$pmf_thumb_size = 185;
if (isset($_SESSION['pmf_thumb_size']) &&
	$_SESSION['pmf_thumb_size'] != ''
) $pmf_thumb_size = $_SESSION['pmf_thumb_size'];
