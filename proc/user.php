...
{
	if (isset($_COOKIE['stored_user_id']) && $_COOKIE['stored_user_id'] != '' && isset($_COOKIE['stored_user_hash']) &&
		$_COOKIE['stored_user_hash'] != ''
	)
	{
		$_SESSION['user_id'] = $_COOKIE['stored_user_id'];
		$_SESSION['user_hash'] = $_COOKIE['stored_user_hash'];
	}
	if (!isset($_SESSION['user_id']) || $_SESSION['user_id'] == '' || !isset($_SESSION['user_hash']) ||
		$_SESSION['user_hash'] == ''
	) return false;
